...
import { createProductList, SortMode, StockStatus } from "./ProductList.js";
...
const cloneProducts = (items: Product[]): Product[] => {
...
const saveProducts = (items: Product[]): void => {
    localStorage.setItem(STORAGE_KEY, JSON.stringify(items));
};

let items: Product[] = loadInitialProducts();
...
const applySort = (list: Product[], sort: SortMode): Product[] => {
